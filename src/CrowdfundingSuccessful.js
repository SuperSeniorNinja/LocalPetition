			...
			<div id="header">
				...
				<p className="menu1 small-headlines   ">
					<Link to="/" className="">
						Petitionen </Link>
					|
					<Link to="/crowdfunding-erfolgreich" className="strong"> Crowdfunding
					</Link>
				</p>
				...
				<p className="menu2 small-headlines ">
					<Link to="/crowdfunding" className="">
						Aktiv </Link>
					|
					<Link to="/crowdfunding-erfolgreich" className="strong"> Erfolgreich
					</Link>
				</p>

				<p className="last-menu small-headlines">
					<Link to="/crowdfunding-erfolgreich" className="strong">
						Am nächsten </Link>
					|
					<Link to="/crowdfunding-erfolgreich-neuste" className=""> Neuste
					</Link>
				</p>
			</div>
