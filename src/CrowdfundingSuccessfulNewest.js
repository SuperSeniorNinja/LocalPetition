			...
			<div id="header">
				...
				<p className="menu1 small-headlines   ">
					<Link to="/" className="">
						Petitionen </Link>
					|
					<Link to="/crowdfunding-erfolgreich-neuste" className="strong"> Crowdfunding
					</Link>
				</p>

				<p className="menu2 small-headlines ">
					<Link to="/crowdfunding-aktiv-neuste" className="">
						Aktiv </Link>
					|
					<Link to="/crowdfunding-erfolgreich-neuste" className="strong"> Erfolgreich
					</Link>
				</p>

				<p className="last-menu small-headlines">
					<Link to="/crowdfunding-erfolgreich" className="">
						Am nächsten </Link>
					|
					<Link to="/crowdfunding-erfolgreich-neuste" className="strong"> Neuste
					</Link>
				</p>
			</div>
