...
export const Imprint = () => {
	...
	return (
		...
		<div >
			...
			<br /><br />
			<strong>Urheberrecht © 2021-2022 LocalPetition UG (haftungsbeschränkt). <br /> Alle Rechte vorbehalten.   </strong>
