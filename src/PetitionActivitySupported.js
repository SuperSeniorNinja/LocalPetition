	...
	return (
		...
		<div >
			<div className="casual-header-div">
				...
				<p className="activity-further-selectors"  > <Link to="/petitionen-activity">Markiert</Link> | <Link to="/petitionen-activity-supported"><strong>Unterstützt</strong> </Link>| <Link to="/petitionen-activity-created">Erstellt</Link></p>
			</div>
