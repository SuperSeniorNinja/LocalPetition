	...
	return (
		<div >
			<div id="header">
				...
				<p className="menu1 small-headlines"> <Link className="strong" to="/petitionen-akzeptiert">Petitionen</Link> | <Link
					to="/crowdfunding">Crowdfunding</Link>
				</p>
				<p className="menu2 small-headlines "> <Link to="/" className="">Aktiv </Link>|<Link
					to="/petitionen-akzeptiert" className="strong" > Akzeptiert </Link>| <Link to="/petitionen-abgelehnt" className="">
						Abgelehnt </Link> </p>
				<p className="last-menu small-headlines"> <Link to="/petitionen-akzeptiert" className="strong">Am nächsten </Link>| <Link
					to="/petitionen-akzeptiert-neuste" className=""> Neuste </Link>| <Link to="/petitionen-akzeptiert-am-beliebtesten" className=""> Beliebtest</Link> </p>
