	...
	return (
		<div >
			<div id="header">
				...
				<p className="menu1 small-headlines"> <Link className="strong" to="/petitionen-akzeptiert-am-beliebtesten">Petitionen</Link> | <Link
				...
				<p className="menu2 small-headlines "> <Link to="/petitionen-aktiv-am-beliebtesten" className="">Aktiv </Link>|<Link
					to="/petitionen-akzeptiert-am-beliebtesten" className="strong" > Akzeptiert </Link>| <Link to="/petitionen-abgelehnt-am-beliebtesten" className="">
						Abgelehnt </Link> </p>
				<p className="last-menu small-headlines"> <Link to="/petitionen-akzeptiert" className="">Am nächsten </Link>| <Link
					to="/petitionen-akzeptiert-neuste" className=""> Neuste </Link>| <Link to="/petitionen-akzeptiert-am-beliebtesten" className="strong"> Beliebtest</Link> </p>
