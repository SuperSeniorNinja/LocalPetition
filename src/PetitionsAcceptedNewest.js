	...
	return (
		<div>
			<div id="header">
				...
				<p className="menu1 small-headlines"> <Link className="strong" to="/petitionen-akzeptiert-neuste">Petitionen</Link> | <Link
				...
				<p className="menu2 small-headlines "> <Link to="/petitionen-aktiv-neuste" className="">Aktiv </Link>|<Link
					to="/petitionen-akzeptiert-neuste" className="strong" > Akzeptiert </Link>| <Link to="/petitionen-abgelehnt-neuste" className="">
						Abgelehnt </Link> </p>
				<p className="last-menu small-headlines"> <Link to="/petitionen-akzeptiert" className="">Am nächsten </Link>| <Link
					to="/petitionen-akzeptiert-neuste" className="strong"> Neuste </Link>| <Link to="/petitionen-akzeptiert-am-beliebtesten" className=""> Beliebtest</Link> </p>
