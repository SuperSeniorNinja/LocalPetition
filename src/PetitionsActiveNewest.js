	...
	return (
		<div >
			<div id="header">
				...
				<p className="menu1 small-headlines"> <Link className="strong" to="/petitionen-aktiv-neuste">Petitionen</Link> | <Link
					to="/crowdfunding">Crowdfunding</Link>
				</p>
				<p className="menu2 small-headlines "> <Link to="/petitionen-aktiv-neuste" className="strong">Aktiv </Link>|<Link
					to="/petitionen-akzeptiert-neuste" className="" > Akzeptiert </Link>| <Link to="/petitionen-abgelehnt-neuste" className="">
						Abgelehnt </Link> </p>
				<p className="last-menu small-headlines"> <Link to="/" className="">Am nächsten </Link>| <Link
					to="/petitionen-aktiv-neuste" className="strong"> Neuste </Link>| <Link to="/petitionen-aktiv-am-beliebtesten" className=""> Beliebtest</Link> </p>
