	...
	return (
		<div>
			<div id="header">
				...
				<p className="menu1 small-headlines"> <Link className="strong" to="/petitionen-abgelehnt">Petitionen</Link> | <Link
					to="/crowdfunding">Crowdfunding</Link>
				</p>
				<p className="menu2 small-headlines "> <Link to="/" className="">Aktiv </Link>|<Link
					to="/petitionen-akzeptiert" className="" > Akzeptiert </Link>| <Link to="/petitionen-abgelehnt" className="strong">
						Abgelehnt </Link> </p>
				<p className="last-menu small-headlines"> <Link to="/petitionen-abgelehnt" className="strong">Am nächsten </Link>| <Link
					to="" className="/petitionen-abgelehnt-neuste"> Neuste </Link>| <Link to="/petitionen-abgelehnt-am-beliebtesten" className=""> Beliebtest</Link> </p>
